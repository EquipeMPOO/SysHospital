...
public class Modificar_prontuarioGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Modificar_prontuarioGUI() {
	...
	public void criarTextArea(){
		...
		list.setModel(new AbstractListModel() {
			String[] values = new String[] {"Listagem...", "Gonorreia", "Gripe Aviaria", "Catapora"};
			public int getSize() {
