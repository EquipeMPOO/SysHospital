...
public class ProntuarioGUI extends JFrame {
	...
	private JLabel lblProntuario,lblPeso, lblAltura, lblDoencas,lblFerimentos,lblDescricaoAtendimento;
	...
	public ProntuarioGUI() {
		...
		// - Confirando o frame e o contentPane
			...
			public void criarLabel(){ 
				...
				lblProntuario = new JLabel("Prontuario");
				lblProntuario.setFont(new Font("Georgia", Font.ITALIC, 25));
				lblProntuario.setBounds(170, 11, 143, 33);
